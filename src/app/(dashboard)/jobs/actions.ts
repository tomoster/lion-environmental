...
export async function updateProperty(propertyId: string, formData: FormData): Promise<void> {
  ...
  const data: Record<string, unknown> = {
    ...
    has_studios_1bed: formData.get("has_studios_1bed") === "true",
    has_2_3bed: formData.get("has_2_3bed") === "true",
    has_common_spaces: formData.get("has_common_spaces") === "true",
    has_wipes: formData.get("has_wipes") === "true",
    has_asbestos_samples: formData.get("has_asbestos_samples") === "true",
    num_units: formData.get("num_units") ? Number(formData.get("num_units")) : null,
